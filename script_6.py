...
const { ShopifySyncScheduler } = require('./services/shopifyService');
...
print("Created enhanced server.js with:")
print("- Production and development configurations")
print("- Enhanced security with Helmet")
print("- Better error handling and logging")
print("- Graceful shutdown handling")  
print("- React build serving in production")
print("- Comprehensive middleware setup")

with open('enhanced_server.js', 'w') as f:
